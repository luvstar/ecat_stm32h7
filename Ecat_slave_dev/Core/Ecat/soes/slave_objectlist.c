...
// [중요] 0x7000을 제조사 전용 영역인 0x2100으로 변경
uint32_t rxpdo_map_1[8] = {0x21000110, 0x21000520, 0x21000920, 0x21000D20, 0x21001120, 0x21001520, 0x21001908, 0x21001D08};
uint32_t rxpdo_map_2[8] = {0x21000210, 0x21000620, 0x21000A20, 0x21000E20, 0x21001220, 0x21001620, 0x21001A08, 0x21001E08};
uint32_t rxpdo_map_3[8] = {0x21000310, 0x21000720, 0x21000B20, 0x21000F20, 0x21001320, 0x21001720, 0x21001B08, 0x21001F08};
uint32_t rxpdo_map_4[8] = {0x21000410, 0x21000820, 0x21000C20, 0x21001020, 0x21001420, 0x21001820, 0x21001C08, 0x21002008};

// [중요] 0x6000을 제조사 전용 영역인 0x2000으로 변경
...
//const _objd SDO1600[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 8, &rxpdo_map_count[0]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[2]}, {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[3]}, {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[4]}, {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[5]}, {0x07, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[6]}, {0x08, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_1[7]}};
//const _objd SDO1601[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 8, &rxpdo_map_count[1]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[2]}, {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[3]}, {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[4]}, {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[5]}, {0x07, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[6]}, {0x08, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_2[7]}};
//const _objd SDO1602[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 8, &rxpdo_map_count[2]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[2]}, {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[3]}, {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[4]}, {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[5]}, {0x07, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[6]}, {0x08, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_3[7]}};
//const _objd SDO1603[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 8, &rxpdo_map_count[3]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[2]}, {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[3]}, {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[4]}, {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[5]}, {0x07, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[6]}, {0x08, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &rxpdo_map_4[7]}};
//
//const _objd SDO1A00[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 3, &txpdo_map_count[0]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_1[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_1[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_1[2]}};
//const _objd SDO1A01[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 3, &txpdo_map_count[1]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_2[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_2[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_2[2]}};
//const _objd SDO1A02[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 3, &txpdo_map_count[2]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_3[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_3[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_3[2]}};
//const _objd SDO1A03[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 3, &txpdo_map_count[3]}, {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_4[0]}, {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_4[1]}, {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0, &txpdo_map_4[2]}};
//
//const _objd SDO1C00[] = {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, "Count", 4, &sm_comm_type_count}, {0x01, DTYPE_UNSIGNED8, 8, ATYPE_RO, "Type0", 1, &sm_comm_types[0]}, {0x02, DTYPE_UNSIGNED8, 8, ATYPE_RO, "Type1", 2, &sm_comm_types[1]}, {0x03, DTYPE_UNSIGNED8, 8, ATYPE_RO, "Type2", 3, &sm_comm_types[2]}, {0x04, DTYPE_UNSIGNED8, 8, ATYPE_RO, "Type3", 4, &sm_comm_types[3]}};

// --- RxPDO Mapping Objects (0x1600 - 0x1603) ---
const _objd SDO1600[] = {
  {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, "Count", 8, &rxpdo_map_count[0]},
  {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000110, &rxpdo_map_1[0]},
  {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000520, &rxpdo_map_1[1]},
  {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000920, &rxpdo_map_1[2]},
  {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000D20, &rxpdo_map_1[3]},
  {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001120, &rxpdo_map_1[4]},
  {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001520, &rxpdo_map_1[5]},
...
const _objd SDO1601[] = {
  ...
  {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000210, &rxpdo_map_2[0]},
  {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000620, &rxpdo_map_2[1]},
  {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000A20, &rxpdo_map_2[2]},
  {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000E20, &rxpdo_map_2[3]},
  {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001220, &rxpdo_map_2[4]},
  {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001620, &rxpdo_map_2[5]},
...
const _objd SDO1602[] = {
  ...
  {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000310, &rxpdo_map_3[0]},
  {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000720, &rxpdo_map_3[1]},
  {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000B20, &rxpdo_map_3[2]},
  {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000F20, &rxpdo_map_3[3]},
  {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001320, &rxpdo_map_3[4]},
  {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001720, &rxpdo_map_3[5]},
...
const _objd SDO1603[] = {
  ...
  {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000410, &rxpdo_map_4[0]},
  {0x02, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000820, &rxpdo_map_4[1]},
  {0x03, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21000C20, &rxpdo_map_4[2]},
  {0x04, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001020, &rxpdo_map_4[3]},
  {0x05, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001420, &rxpdo_map_4[4]},
  {0x06, DTYPE_UNSIGNED32, 32, ATYPE_RO, acNameMapping, 0x21001820, &rxpdo_map_4[5]},
...
const _objectlist SDOobjects[] = {
  {0x1000, OTYPE_VAR,     1,  1, "Device Type", SDO1000}, // 1순위
  {0x1018, OTYPE_RECORD,  4,  5, acName1018, SDO1018},     // 2순위
  ...
  {0x2000, OTYPE_RECORD, 12, 13, "Tx Data", SDO2000},     // 0x2000대로 이동
  {0x2100, OTYPE_RECORD, 32, 33, "Rx Data", SDO2100},     // 0x2100대로 이동
  {0xffff, 0xff, 0xff, 0xff, NULL, NULL}
};

//const _objectlist SDOobjects[] = {
//  {0x1000, OTYPE_VAR,     1,  1, "Device Type", SDO1000}, // 0x1000 추가
//  {0x1018, OTYPE_RECORD,  4,  5, acName1018, SDO1018},
//  {0x1600, OTYPE_RECORD,  8,  9, "Rx1", SDO1600}, {0x1601, OTYPE_RECORD,  8,  9, "Rx2", SDO1601},
//  {0x1602, OTYPE_RECORD,  8,  9, "Rx3", SDO1602}, {0x1603, OTYPE_RECORD,  8,  9, "Rx4", SDO1603},
//  {0x1A00, OTYPE_RECORD,  3,  4, "Tx1", SDO1A00}, {0x1A01, OTYPE_RECORD,  3,  4, "Tx2", SDO1A01},
//  {0x1A02, OTYPE_RECORD,  3,  4, "Tx3", SDO1A02}, {0x1A03, OTYPE_RECORD,  3,  4, "Tx4", SDO1A03},
//  {0x1C00, OTYPE_ARRAY,   4,  5, acName1C00, SDO1C00},
//  {0x1C12, OTYPE_ARRAY,   4,  5, acName1C12, SDO1C12},
//  {0x1C13, OTYPE_ARRAY,   4,  5, acName1C13, SDO1C13},
//  {0x2000, OTYPE_RECORD, 12, 13, "Tx Data", SDO2000}, // 0x6000 -> 0x2000으로 교체
//  {0x2100, OTYPE_RECORD, 32, 33, "Rx Data", SDO2100}, // 0x7000 -> 0x2100으로 교체
//  {0xffff, 0xff, 0xff, 0xff, NULL, NULL}
//};
